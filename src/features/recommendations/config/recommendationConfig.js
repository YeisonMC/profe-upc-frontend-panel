const normalizePath = (value, fallback) => {
  ...
  const normalizedValue = selectedValue.startsWith("/")
    ? selectedValue
    : `/${selectedValue}`;
...
export const RECOMMENDATION_STATUS_OPTIONS = Object.freeze([
  { value: RECOMMENDATION_STATUS.all, label: "Todas" },
  { value: RECOMMENDATION_STATUS.pending, label: "Pendientes" },
  { value: RECOMMENDATION_STATUS.reviewed, label: "Revisadas" },
  { value: RECOMMENDATION_STATUS.rejected, label: "Rechazadas" },
]);
